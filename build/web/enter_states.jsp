<%-- 
    Document   : enter_states
    Created on : 3-Nov-2018, 10:56:43 AM
    Author     : Nitin
--%>
...
<form action="enter_state_details.jsp" method="post" >
            <div class="col-lg-3"></div>
            <div class="col-lg-6">
               <table  align="center"  class="table table-hover table-bordered">
                <tr> <h3 align="center">Add State Name</h3></tr>
               <tr>
               <select name="country" class="form-control dropdown">
                   ...
                   <%
                    ...
                    {
                    %>
                    <option value="<%=rs.getInt("id")%>"><%=rs.getString("countryname")%></option>
                    <% }
                   %>
               </select>
                ...
                <tr>
                    <td>Enter State</td>   
                    <td><input type="text" name="snm" class="form-control"></td>
                </tr>
                <tr>  
