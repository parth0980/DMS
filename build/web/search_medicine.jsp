<%-- 
    ...
    Created on : 29-Nov-2018, 1:15:09 PM
    Author     : Nitin
--%>
                                 ...
                                 <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                                     <h2> Allopathy </h2>
                                         ...
                                         <%
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td class="text-uppercase"><b><%=rs.getString("dname")%></b><td>
                                                            ...
                                                            while(rs1.next())
                                                            { %>
                                                                <td class="text-black"><b><%=rs1.getString("m_name")%></b></td>
                                                                <td class="text-black"><%=rs1.getString("m_details")%></td>
                                                                <td><img src="get_img.jsp?id1=<%=rs1.getInt("id")%>" height="350" width="350"></td>
                                                            <% }
                                                            %>
                                                            </tr> 
                                                        <br>
                                                        ...
                                                        <h2> Homeopathy </h2>
                                                         <%
                                                             String qry="select * from homeopathy where did='"+a+"'";
                                                            PreparedStatement ps2=con.prepareStatement(qry);
                                                            ResultSet rs2=ps2.executeQuery();
                                                            while(rs2.next())
                                                            { %>
                                                            <tr><td class="text-black"><b><%=rs2.getString("hname")%></b></td>
                                                                <td class="text-black"><%=rs2.getString("hdetails")%></td>
                                                                <td><a href="file_download?i=<%=rs2.getInt("id")%>"><%=rs2.getString("fname")%><br></a></td>
                                                            </tr>
                                                           ...
                                                           <% } %>
                                                            ...
                                                            Make sure spell is correct\n\ ");
                                                             window.location="view_medicine_user.jsp";
                                                             </script>
                                                            <% } 
                                                            %>
