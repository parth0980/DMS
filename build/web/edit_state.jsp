<%-- 
    Document   : edit_state
    Created on : 3-Nov-2018, 11:53:03 AM
    Author     : Nitin
--%>
...
<form action="edit_state_details.jsp" method="post" >
            ...
            String q="select * from state where id='"+ide+"'";
            ...
            if (rs.next())
            {
                ...
                <tr>
                    ...
                    <td><input type="hidden" value="<%=rs.getInt("id")%>" name="i">
                     <input type="text" value="<%=rs.getString("statename")%>" name="snm" class="form-control"></td>
                </tr>
                <%
                }
                %>
