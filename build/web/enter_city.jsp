<%-- 
    Document   : enter_city
    Created on : 3-Nov-2018, 5:57:48 PM
    Author     : Nitin
--%>
...
<form action="enter_city_details.jsp" method="post" >
            <div class="col-lg-3"></div>
            <div class="col-lg-6">
               <table  align="center"  class="table table-hover table-bordered">
                <tr> <h3 align="center">Add City Name</h3></tr>
               ...
               <select name="state" class="form-control dropdown">
                   ...
                   <%
                    ...
                    {
                    %>
                    <option value="<%=rs.getInt("id")%>"><%=rs.getString("statename")%></option>
                    <% }
                   %>
               </select>
                ...
                <tr>
                    <td>City Name</td>   
                    <td><input type="text" name="cnm" class="form-control"></td>
                </tr>
                <tr>  
