...
public final class find_005fby_005fsymptoms_005fcode_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try{
        ...
        try {
            ...
            Logger.getLogger(find_005fby_005fsymptoms_005fcode_jsp.class.getName()).log(Level.SEVERE, null, ex);
        }
        int i=Integer.parseInt(request.getParameter("symptoms"));
        String qry="select * from add_disease where id='"+i+"'";
