<%-- 
    ...
    Created on : 30-Oct-2018, 11:21:53 AM
    Author     : Nitin
--%>
     ...
     <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Doctors <span class="caret"></span></a>
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" >Appointments <span class="caret"></span></a>
        ...
        <!--for cuurent page, begins -->
                 ...
                 <form action="add_medicine_details" method="post" enctype="multipart/form-data">
            <div class="col-lg-3"></div>
            <div class="col-lg-6">
               <table  align="center"  class="table table-hover table-bordered">
                <tr> <h3 align="center">Add Medicine</h3></tr>
          ...
          <% }
           %>  
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="file" name="image" class="form-control">
                </tr>
                <tr>  
