<%-- 
    ...
    Created on : 3-Nov-2018, 11:15:05 AM
    Author     : Nitin
--%>
        ...
        <!-- for current page-->
         ...
         <div class="col-lg-6">
           <table align="center" class="table table-hover table-bordered table-striped">
            <tr>
            <a href="enter_states.jsp" colspan="3" class="btn btn-primary  form-control"> ADD NEW STATES </a>
                 <br>
                 <br>
               </tr>
            <tr>
            ...
            String q="select country.countryname,state.id,state.statename from state inner join country on state.countryid=country.id";
            ...
            <tr>
                ...
                <td align="center">
                    <a  href="edit_state.jsp?i=<%=rs.getInt("id")%>" rel="" class="btn btn-info">Edit</a>
                    <a  href="delete_state.jsp?i=<%=rs.getInt("id")%>" onclick="return confirm('are you sure to delete?');" rel="" class="btn btn-danger">Delete</a>
                </td>
            </tr>
