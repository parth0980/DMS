<%-- 
    Document   : view_city
    Created on : 3-Nov-2018, 6:17:41 PM
    Author     : Nitin
--%>
        ...
        <!-- for current page-->
         ...
         <div class="col-lg-6">
           <table align="center" class="table table-hover table-bordered table-striped">
            <tr>
            <a href="enter_city.jsp" colspan="3" class="btn btn-primary  form-control"> ADD NEW CITIES </a>
                 <br>
                 <br>
               </tr>
            <tr>
            ...
            String q="select city.id,state.statename,city.stateid,city.cityname from city "
            ...
            <tr>
                ...
                <td align="center">
                    <a  href="edit_city.jsp?i=<%=rs.getInt("id")%>" rel="" class="btn btn-info">Edit</a>
                    <a  href="delete_city.jsp?i=<%=rs.getInt("id")%>" onclick="return confirm('are you sure to delete?');" rel="" class="btn btn-danger">Delete</a>
                </td>
            </tr>
