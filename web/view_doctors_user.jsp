<%-- 
    Document   : view_doctors_user
    Created on : 22-Nov-2018, 6:49:46 PM
    Author     : Nitin
--%>
        ...
        <a href="user_home.jsp" class="primary-btn text-uppercase">Search through Disease</a>
         <a href="logout_user.jsp" class="btn btn-primary text-white text-uppercase ">Logout</a>
			...
			<!-- End banner Area -->
                        ...
                        <form action="search_doctors.jsp" method="post">
                        <table class="table table-bordered form-control">
                            ...
                            <tr>
                            <input type="submit" value="Find Doctors" class="btn-info text-heading">
                            </tr>
                        </table>
                        </form>
                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-8">
                                 <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                                     <tr>
                                         <th>Specialist of</th><th colspan="2">Doctor Name</th><th colspan="">Image</th>
                                     </tr>
                                         <%
                                                            Connection con=null;
                                                            ...
                                                            while(rs1.next())
                                                            { %>
                                                                <td class="text-black"><b><%=rs1.getString("name")%></b></td>
                                                                <td><img src="get_doctors_img.jsp?id1=<%=rs1.getInt("id")%>"></></td>
                                                            <% }
                                                            %>
                                                            </tr> 
                                                            <%}
