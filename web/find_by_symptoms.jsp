<%-- 
    Document   : find_by_symptoms
    Created on : 22-Nov-2018, 12:37:53 PM
    Author     : Nitin
--%>
			...
			<!-- End banner Area -->
                        <section class="appointment-area">
                            <div class="container">
                                ...
                                <div class="col-lg-8">
                                    <form action="find_by_symptoms_code.jsp" method="post">
                                    <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                                                        <tr>
                                                        <br>
                                                        <br>
                                                        <select name="symptoms" class="dropdown-header form-control text-uppercase text-primary">
                                                            <option selected="selected" ><b>---choose symptoms that you feel---</b></option>
                                                        <%
                                                            Connection con=null;
                                                            ...
                                                            {
                                                            %>
                                                        <option value="<%=rs.getInt("id")%>"><%=rs.getString("symptoms_details")%></option>
                                                            <% }
                                                            %>
                                                        </select>
                                                     </tr> 
                                                     <tr>
                                                     <button type="Submit" class="primary-btn text-uppercase">Go</button>
                                                     </tr>
                                                     <br><br>
                                                    </table>	
                                    </form>
