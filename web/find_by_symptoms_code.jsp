<%-- 
    Document   : find_by_symptoms_code
    Created on : 22-Nov-2018, 1:47:08 PM
    Author     : Nitin
--%>
         ...
         <a href="logout_user.jsp" class="btn btn-primary text-white text-uppercase ">Logout</a>
			...
			<!-- End banner Area -->
                ...
                <%
                    ...
                    int i=Integer.parseInt(request.getParameter("symptoms"));
                    String qry="select * from symptoms_details where id='"+i+"'";
                 ...
                 <tr>
                     ...
                     <%int a = rs1.getInt("did");
                             
                     String qr="select * from add_disease where id='"+a+"'";
                     PreparedStatement ps2=con.prepareStatement(qr);
                    ResultSet rs2=ps2.executeQuery();
                    if(rs2.next())
                            {
                            %>
                     <td class="text text-uppercase text-heading"><b><%=rs2.getString("dname")%></b></td>
                     ...
                     <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                <%
                String q="select * from symptoms_details where did='"+a+"'";
                 ...
                 <tr>
                     ...
                     <td><span class="glyphicon glyphicon-hand-right"></span></td>
                     <td>   <%=rs3.getString("symptoms_details")%></td>
                        </tr>
                        <br><br>
                        </table>
                        <%
                    ...
                    String query="select * from medicine where did='"+a+"'";
                ...
                %>
                 ...
                 <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                        <tr>
                            ...
                            <td><h5>Name</h5></td>
                            <td><%=rs4.getString("m_name")%></td>
                        </tr>
                        <tr>  
                            <td><h5>Details </h5></td>
                            <td><%=rs4.getString("m_details")%></td>
                        <tr>
                            <td colspan=""><h5>Image </h5></td>
                            <td><img src="get_img.jsp?id1=<%=rs4.getInt("id")%>" height="300" width="300"></td></tr>
                        </tr>
                        <br><br>
                 </table>
                <%
                }
                 String query1="select * from homeopathy where did='"+a+"'";
                ...
                %>
                 ...
                 <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                        <tr>
                            ...
                            <td><h5>Name</h5></td>
                            <td><%=rs5.getString("hname")%></td>
                        </tr>
                        <tr>  
                            <td><h5>Details </h5></td>
                            <td><%=rs5.getString("hdetails")%></td>
                        <tr>
                            <td colspan=""><h5>File </h5></td>
                            <td><%=rs5.getString("fname")%></td>
                            <td><button class="btn-block"><a href="file_download?i=<%=rs5.getInt("id")%>">Download</a></button></td>
                ...
                <%
                 ...
                 String que="select doctors.id,doctors.name,doctors.qualification,doctors.fees,doctors.contact,doctors.email,doctors.address,doctors.fdata,city.cityname,state.statename,country.countryname from doctors"
                    ...
                    + "inner join country on country.id=doctors.countryid where did='"+a+"'";
                  PreparedStatement ps6=con.prepareStatement(que);
                 ...
                 while(rs6.next())
                {
                 ...
                 <table class="table" style="color: #000;font-size: 18px; font-family: Poppins">
                        ...
                        <tr>  
                            ...
                            <td><%=rs6.getString("qualification")%></td>
                        </tr>
                         <tr>  
                            <td><h5>Counsult Fee </h5></td>
                            <td><%=rs6.getString("fees")%></td>
                        </tr>
                        <tr>  <td> </td>
                             <td><h5>Contact</h5></td>
                             <td><%=rs6.getString("contact")%></td>   
                        ...
                        <tr> 
                         ...
                         <tr>  
                            <td></td>
                            <td><h5>Address </h5></td>
                            <td><%=rs6.getString("address")%>, <%=rs6.getString("cityname")%>, <%=rs6.getString("statename")%>, <%=rs6.getString("countryname")%></td>
                        ...
                        <tr><td></td>
                            ...
                            <td><img src="get_doctors_img.jsp?id1=<%=rs6.getInt("id")%>" height="300" width="300"></td>
