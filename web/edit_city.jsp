<%-- 
    Document   : edit_city
    Created on : 10-Nov-2018, 5:01:02 PM
    Author     : Nitin
--%>
...
<form action="edit_city_details.jsp" method="post" >
            <div class="col-lg-3"></div>
            <div class="col-lg-6">
               <table  align="center"  class="table table-hover table-bordered">
                <tr> <h3 align="center">Edit City Name</h3></tr>
               <%
                   Connection con=null;
            ...
            String q="select * from city where id='"+ide+"'";
            ...
            if (rs.next())
            {
                ...
                <tr>
                    ...
                    <td><input type="hidden" value="<%=rs.getInt("id")%>" name="i">
                     <input type="text" value="<%=rs.getString("cityname")%>" name="cnm" class="form-control"></td>
                </tr>
                <%
                }
                %>
